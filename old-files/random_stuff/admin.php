...
$auth_users = array(
    'admin' => '$2y$10$OVK7fTp4mHRz67ICzBXBEONfKwWsNNYOWKc8HHzFX4XTktSwLc1VS', //admin@123
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <img src="https://nephilim.tech/image/neplogo.png" />
                        </div>
                        <div class="text-center">
                            <h1 class="card-title">Nephilim ADMIN Panel</h1>
                        </div>
                        <div class="card fat">
                            <div class="card-body">
                        ...
                        <div class="footer text-center">
                            ...
                            <a href="https://nephilim.tech" target="_blank" class="text-muted">Nephilim Tech</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<head>
    ...
    <link rel="icon" href="https://nephilim.tech/img/neplogo.png" type="image/png">
    <title>ADMIN | NephilimTech</title>
